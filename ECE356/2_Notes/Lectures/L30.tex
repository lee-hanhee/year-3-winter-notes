...
\begin{process}
    \begin{enumerate}
        ...
        \item Draw the Bode plot of $K G(j \omega)$ and find PM. Given the desired $\text{PM}_{\text{desired}}$, let $\Delta \phi = \text{PM}_{\text{desired}} - \text{PM}$. Set $\phi_{\max} = \Delta \phi + \text{Extra Margin}$
    \end{enumerate}
\end{process}
