...
\begin{example}
    ...
    \begin{center}
        \begin{tabular}{ccccccc}
            \toprule
            $s$ & $a$ & $q^*(s,a,0)$ & $q^*(s,a,1)$ & $q^*(s,a,2)$ & $q^*(s,a,3)$ & $a^*(s,2)$ \\
            \midrule
            empty & hunt & 0 & 2 & 2& 2 & seed \\
            empty & seed & 0 & 0 & 1& 2.1 & seed \\
            ...
            \begin{itemize}
                ...
                \item $q^*(\text{empty}, \text{hunt}, 3) = 0.5(4 + 0) + 0.5(0 + 0) = 2$
                \item $q^*(\text{empty}, \text{seed}, 3) = 1(0 + 1\cdot 2.1) = 2.1$
            \end{itemize}} \\
            \midrule
            ga & grab & 0 & 1& 1 & 1 & clock \\
            ga & clock & 0 & 0& 2.1 & 2.1 & clock \\
            \multicolumn{7}{p{\linewidth}}{
            \begin{itemize}
                ...
                \item $q^*(\text{ga}, \text{grab}, 3) = 1(1 + 0) = 1$
                \item $q^*(\text{ga}, \text{clock}, 3) = 0.7(0 + 3) + 0.3(0 + 0) = 2.1$
            \end{itemize}} \\
            \midrule
            dead & - & 0 & 0 & 0 & 0 & - \\
            \multicolumn{7}{p{\linewidth}}{
