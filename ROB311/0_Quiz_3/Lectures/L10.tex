...
\begin{example}
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Action sequence is $\langle a_1, a_2, a_3 \rangle = \langle \text{seed}, \text{clock}, \text{clock} \rangle$.
            \item Observation sequence is $\langle o_0, o_1, o_2, o_3 \rangle = \langle \left(\text{:(,blank}\right), \left(\text{:(,ga)}\right), \left(\text{:(,sra)}\right), \left(\text{:|,sra)}\right) \rangle$.
