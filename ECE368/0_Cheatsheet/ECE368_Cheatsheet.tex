...
\begin{paracol}{3}
    ...
    *$\underline{Y}$: Vector of indep. Gaussian RVs.
    ...
    \textcolor{darkgreen}{\textbf{MAP Rule:}} $\hat{c} = \arg \max_c P_C[c | \underline{X} = \underline{x}]$ \\
    $\hat{c} = \arg \max_c f_{\underline{X} \mid C} (\underline{x} \mid c) \pi_c$ \\
