...
\begin{paracol}{3}
    ...
    *\textbf{Purpose:} Clarify the dependencies among a set of RVs to simplify the calculation of joint probabilities. 
    ...
    \textcolor{green}{\textbf{Common Cause (Tail to Tail):}} 

    \textcolor{green}{\textbf{Causal Chain (Head to Tail or Tail to Head):}} 

    \textcolor{green}{\textbf{Common Effect (Head to Head):}}
